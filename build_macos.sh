...
g++ -dynamiclib -I src/main/native -o src/main/resources/macos-amd64/libwhisperjni.dylib src/main/native/ggml.o src/main/native/io_github_givimad_whisperjni_WhisperJNI.o -lc
